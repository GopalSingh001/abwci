  ...
  return (
    <Layout>
      ...
      >
        ...
        {/* Frame 7962 - Activity Reports List */}
        <div 
          style={{
            display: 'flex',
        ...
        >
          {/* Frame 7960 - Activity Report 2022-23 */}
          <div
            style={{
          ...
          >
            ...
            <a
              href="/downloads/activity-reports/ABWCI Activity Report_F_2022-23.pdf"
              download
              target="_blank"
          ...
          {/* Frame 7961 - Activity Report 2023-24 */}
          <div
            style={{
              boxSizing: 'border-box',
              display: 'flex',
          ...
          >
            ...
            <a
              href="/downloads/activity-reports/ABWCI Activity Report_F_2023-24.pdf"
              download
              target="_blank"
              rel="noopener noreferrer"
              style={{
          ...
          {/* Frame 7962 - Activity Report 2024-25 */}
          <div
            style={{
              display: 'flex',
              flexDirection: isMobile ? 'column' : 'row',
          ...
          >
            ...
            <a
              href="/downloads/activity-reports/Activity Report_F_ 2024-2025.pdf"
              download
              target="_blank"
              rel="noopener noreferrer"
              style={{
