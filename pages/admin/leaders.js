...
export default function LeadersManagement() {
  ...
  const fetchLeaders = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin/leaders`, {
        headers: {
  ...
  const handleEdit = (leader) => {
    // console.log('🔵 Editing leader:', leader);
    // console.log('🔵 Leader region:', leader.region);
    setEditingLeader(leader);
    const formDataWithRegion = {
      name: leader.name || '',
    ...
    // console.log('🔵 Form data being set:', formDataWithRegion);
    setFormData(formDataWithRegion);
        ...
        <div className="px-8 py-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage leadership profiles and information</p>
            </div>
            <button
              onClick={() => {
                resetForm();
      ...
      <div className="p-8">
        ...
        <div className="mb-8">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search leaders by name or designation..."
              value={searchTerm}
        ...
        {filteredLeaders.length === 0 && !loading && (
          <div className="text-center py-16 bg-white rounded-lg border border-gray-200">
            ...
            <p className="text-gray-500 mb-4">Get started by adding your first leader.</p>
            <button
              onClick={() => {
                resetForm();
                setShowModal(true);
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border-2 border-blue-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors bg-blue-50"
                        placeholder="Enter region (e.g., Asia, Europe, North America)"
                      />
                      <p className="text-xs text-gray-500 mt-1">Current value: {formData.region || '(empty)'}</p>
                    </div>
